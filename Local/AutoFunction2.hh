...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME( \
  spec, currentkeyword, nextkeyword) \
    BOOST_PP_CAT( \
      WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME_IMPL, \
      BOOST_PP_CAT(WG_PP_TOKENS_STARTWITH_, currentkeyword) (spec)) \
      (spec, currentkeyword, nextkeyword)
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME_IMPL0( \
  spec, currentkeyword, nextkeyword) \
    (BOOST_PP_NIL) \
      BOOST_PP_CAT(WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_, nextkeyword)
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME_IMPL1( \
  spec, currentkeyword, nextkeyword) \
    BOOST_PP_CAT(WG_PP_AUTOFUNCTION_SPEC_PROCESS_, currentkeyword)

#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS( \
  spec, currentkeyword, nextkeyword) \
    BOOST_PP_CAT( \
      WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS_IMPL, \
      BOOST_PP_CAT(WG_PP_TOKENS_STARTWITH_, currentkeyword) (spec)) \
      (spec, currentkeyword, nextkeyword)
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS_IMPL0( \
  spec, currentkeyword, nextkeyword) \
    (spec)
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS_IMPL1( \
  spec, currentkeyword, nextkeyword) \
    (spec, \
     BOOST_PP_CAT( \
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_ASSIGNTO(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND1( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, ASSIGNTO, RETURN) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, ASSIGNTO, RETURN) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_ASSIGNTO(spec, nexttransform) \
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_RETURN(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND2( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, RETURN, PARAMBIND) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, RETURN, PARAMBIND) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_RETURN(spec, nexttransform) \
  WG_PP_SPLITHEADTUPLEFROMTOKENS( \
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_PARAMBIND(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND3( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, PARAMBIND, PARAMSET) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, PARAMBIND, PARAMSET) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_PARAMBIND(spec, nexttransform) \
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_PARAMSET(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND4( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, PARAMSET, MEMBIND) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, PARAMSET, MEMBIND) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_PARAMSET(spec, nexttransform) \
  WG_PP_SPLITHEADTUPLESEQFROMTOKENS( \
    2, WG_PP_TOKENS_EAT_HEADKEYWORD(spec), WG_PP_TUPLIZE, nexttransform)
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_MEMBIND(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND5( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, MEMBIND, MEMSET) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, MEMBIND, MEMSET) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_MEMBIND(spec, nexttransform) \
  WG_PP_SPLITHEADTUPLESEQFROMTOKENS( \
    1, WG_PP_TOKENS_EAT_HEADKEYWORD(spec), WG_PP_TUPLIZE, nexttransform)
...
#define WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEAD_MEMSET(spec) \
  ...
  WG_PP_AUTOFUNCTION_EXPAND6( \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACRONAME(spec, MEMSET, ENDSPEC) \
    WG_PP_AUTOFUNCTION_SPEC_PROCESSIFHEADIMPL_MACROPARAMS(spec, MEMSET, ENDSPEC) )
#define WG_PP_AUTOFUNCTION_SPEC_PROCESS_MEMSET(spec, nexttransform) \
  WG_PP_SPLITHEADTUPLESEQFROMTOKENS( \
    2, WG_PP_TOKENS_EAT_HEADKEYWORD(spec), WG_PP_TUPLIZE, nexttransform)
