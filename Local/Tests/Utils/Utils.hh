...
#define WG_TEST_ASSERT_LOCALTYPE_ISCONST(obj) \
  WG_TEST_ASSERT_LOCALTYPE_ISCONST_IMPL(obj)

// See WG_TEST_ASSERT_LOCALTYPE.
#define WG_TEST_ASSERT_LOCALTYPE_ISCONST_TPL(obj) \
  WG_TEST_ASSERT_LOCALTYPE_ISCONST_TPL_IMPL(obj)
...
#define WG_TEST_ASSERT_LOCALTYPE_ISCONST_IMPL(obj) \
  WG_TEST_ASSERT_ISCONST( (obj).var )

#define WG_TEST_ASSERT_LOCALTYPE_ISCONST_TPL_IMPL(obj) \
