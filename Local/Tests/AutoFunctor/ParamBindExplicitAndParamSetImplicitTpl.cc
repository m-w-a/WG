...
TEST(wg_autofunctor_parambindexplicitandparamsetimplicittpl, OkIfUsing21Combo)
{
  try
  {
...
TEST(wg_autofunctor_parambindexplicitandparamsetimplicittpl, OkIfLocalTypeBound)
{
  try
  {
