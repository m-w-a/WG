...
//SEQ_REVERSE
BEGIN WG_PP_SEQ_REVERSE(SN1) == BOOST_PP_NIL END
BEGIN WG_PP_SEQ_CAT( WG_PP_SEQ_REVERSE(S1) ) == 1 END
BEGIN WG_PP_SEQ_CAT( WG_PP_SEQ_REVERSE(S2) ) == 32 END
BEGIN WG_PP_SEQ_CAT( WG_PP_SEQ_REVERSE(S3) ) == 654 END
