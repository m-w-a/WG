...
#define WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_TRYEND(scopemngr) \
  BOOST_PP_IIF( \
    ...
    WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_TRYEND2) (scopemngr) \
  \
  scopemngr . exit( WG_PP_LCLCONTEXT_CG_DIDSCOPECOMPLETEFLAG() );

#define WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_TRYEND2(scopemngr) \
  } \
  catch(...) \
  { \
    scopemngr . exit( WG_PP_LCLCONTEXT_CG_DIDSCOPECOMPLETEFLAG() ); \
...
#define WG_PP_LCLCONTEXT_CODEGEN_START_IMPL(symbtbl) \
  { \
    ...
    (void)WG_PP_LCLCONTEXT_NAMES_SCOPEMNGR_AUTOSIMFLAGNAME() ; \
    \
...
#define WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_ADHOC_SCOPEMNGROBJINITARGS_ENTRY3( \
  markedseq) \
    WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_ADHOC_SCOPEMNGROBJINITARGS_ENTRY4( \
      BOOST_PP_SEQ_ELEM( \
        1, \
        WG_PP_TRNSLTR_MARKERS_EATHEADMARKER(markedseq) ) )

#define WG_PP_LCLCONTEXT_CG_SCOPEENTERDCLNS_ADHOC_SCOPEMNGROBJINITARGS_ENTRY4( \
  varname) \
    BOOST_PP_IIF( \
