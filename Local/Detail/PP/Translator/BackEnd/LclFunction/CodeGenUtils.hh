...
#define WG_PP_LCLFUNCTION_CGUTILS_USETYPEALIASER(symbtbl) \
  WG_PP_LCLFUNCTION_CGUTILS_USETYPEALIASER_IMPL(symbtbl)
...
#define WG_PP_LCLFUNCTION_CGUTILS_USETYPEALIASER_IMPL(symbtbl) \
