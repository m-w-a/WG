...
#define WG_PP_LCLFUNCTION_CGUTILS_REPLACEDEDUCEDTYPES(symbtbl) \
  WG_PP_LCLFUNCTION_CGUTILS_REPLACEDEDUCEDTYPES_IMPL(symbtbl)
...
#define WG_PP_LCLFUNCTION_CGUTILS_REPLACEDEDUCEDTYPES_IMPL(symbtbl) \
