    ...
    WG_PP_SPLITHEADTUPLEFROMTOKENS_EXPAND1( \
      WG_PP_SPLITHEADTUPLEFROMTOKENS_IMPL2 \
        WG_PP_SPLITHEADTUPLEFROMTOKENS_EXPAND2( \
          BOOST_PP_LPAREN() \
            WG_PP_ADDCOMMA_AFTERTUPLE(tuplearity, spec) BOOST_PP_COMMA() \
...
WG_PP_SPLITHEADTUPLEFROMTOKENS(1, S1, WG_PP_TUPLIZE_ARG1, head, next)
WG_PP_SPLITHEADTUPLEFROMTOKENS(2, S3, WG_PP_TUPLIZE_ARG2, head, next)
