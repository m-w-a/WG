...
BEGIN WG_PP_VARDCLN_ISEXPLICIT(S7) == 1 END
BEGIN WG_PP_VARDCLN_ISEXPLICIT(S8) == 1 END

BEGIN WG_PP_VARDCLN_ISEXPLICIT_NLT(S1) == 1 END
BEGIN WG_PP_VARDCLN_ISEXPLICIT_NLT(S7) == 1 END
BEGIN WG_PP_VARDCLN_ISEXPLICIT_NLT(S8) == 1 END
