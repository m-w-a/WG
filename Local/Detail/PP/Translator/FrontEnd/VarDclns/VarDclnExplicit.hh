...
#define WG_PP_VARDCLN_EXPLICIT_TUPLIZE_IMPL(explicitvardcln) \
  BOOST_PP_IIF( \
    ...
    WG_PP_VARDCLN_EXPLICIT_TUPLIZE_IMPL_NONLOCAL, \
    WG_PP_VARDCLN_EXPLICIT_TUPLIZE_IMPL2) (explicitvardcln)

#define WG_PP_VARDCLN_EXPLICIT_TUPLIZE_IMPL2(explicitvardcln) \
  BOOST_PP_IIF( \
