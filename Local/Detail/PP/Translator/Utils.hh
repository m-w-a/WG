...
#define WG_PP_TRNSLTR_UTILS_STARTS_WITH_WG_PP_ERROR(tokens) \
  WG_PP_TRNSLTR_UTILS_STARTS_WITH_WG_PP_ERROR_IMPL(tokens)
#define WG_PP_TRNSLTR_UTILS_EATHEADTOKEN_WG_PP_ERROR(tokens) \
  WG_PP_TRNSLTR_UTILS_EATHEADTOKEN_WG_PP_ERROR_IMPL(tokens)

#define WG_PP_TRNSLTR_UTILS_START_WITH_WG_PP_DEDUCEDTYPE(tokens) \
  WG_PP_TRNSLTR_UTILS_START_WITH_WG_PP_DEDUCEDTYPE_IMPL(tokens)
...
#define WG_PP_TRNSLTR_UTILS_TOKEN_MATCHES_WG_PP_ERROR_WG_PP_ERROR (1) /* unary */
#define WG_PP_TRNSLTR_UTILS_STARTS_WITH_WG_PP_ERROR_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_TRNSLTR_UTILS_TOKEN_MATCHES_WG_PP_ERROR_)
...
#define WG_PP_TRNSLTR_UTILS_TOKEN_MATCHES_WG_PP_DEDUCEDTYPE_WG_PP_DEDUCEDTYPE (1) /* unary */
#define WG_PP_TRNSLTR_UTILS_START_WITH_WG_PP_DEDUCEDTYPE_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_TRNSLTR_UTILS_TOKEN_MATCHES_WG_PP_DEDUCEDTYPE_)
