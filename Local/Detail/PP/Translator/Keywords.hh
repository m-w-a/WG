...
#define WG_PP_KEYWORDS_STARTSWITH_MEMDECL(tokens) \
  WG_PP_KEYWORDS_STARTSWITH_MEMDECL_IMPL(tokens)
...
#define WG_PP_KEYWORDS_BEGINSWITH_memdecl_memdecl WG_PP_TOKENMATCH_FRONTMATCH
#define WG_PP_KEYWORDS_STARTSWITH_MEMDECL_IMPL(tokens) \
  WG_PP_TOKENMATCH_BEGINSWITH(\
    tokens, \
    WG_PP_KEYWORDS_BEGINSWITH_memdecl_)
