...
#define WG_PP_KEYWORDS_STARTSWITH_MEMLIKE(tokens) \
  WG_PP_KEYWORDS_STARTSWITH_MEMLIKE_IMPL(tokens)
...
#define WG_PP_KEYWORDS_BEGINSWITH_ppescape_ppescape WG_PP_TOKENMATCH_FRONTMATCH
#define WG_PP_KEYWORDS_STARTSWITH_PPESCAPE_IMPL(tokens) \
  WG_PP_TOKENMATCH_BEGINSWITH(\
    tokens, \
    WG_PP_KEYWORDS_BEGINSWITH_ppescape_)
...
#define WG_PP_KEYWORDS_BEGINSWITH_memlike_memlike WG_PP_TOKENMATCH_FRONTMATCH
#define WG_PP_KEYWORDS_STARTSWITH_MEMLIKE_IMPL(tokens) \
  WG_PP_TOKENMATCH_BEGINSWITH(\
    tokens, \
    WG_PP_KEYWORDS_BEGINSWITH_memlike_)
