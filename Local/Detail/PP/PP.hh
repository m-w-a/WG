...
#if BOOST_PP_VARIADICS
  #define WG_PP_ADDCOMMA_AFTERTUPLE_V(tokens) \
    WG_PP_ADDCOMMA_AFTERTUPLE_IMPLN tokens
#endif
...
#define WG_PP_ADDCOMMA_AFTERTUPLE_IMPL1(x) (x) BOOST_PP_COMMA()
#define WG_PP_ADDCOMMA_AFTERTUPLE_IMPL2(x, y) (x, y) BOOST_PP_COMMA()
#if BOOST_PP_VARIADICS
  #define WG_PP_ADDCOMMA_AFTERTUPLE_IMPLN(...) (__VA_ARGS__) BOOST_PP_COMMA()
#endif
