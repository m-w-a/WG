...
/*
WG_PP_VARDCLNEXPLICIT_TUPLIZE(SG1)
WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL1)
WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL2)
WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL3)
WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL4)
...
#define RESULT WG_PP_VARDCLNEXPLICIT_TUPLIZE(SG1)
...
#define RESULT WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL1)
...
#define RESULT WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL2)
...
#define RESULT WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL3)
  TEST_DIDCAPTURE_TYPE(SomeLocalType * &, EXTRACT_PARSEDTYPE(RESULT))
...
#define RESULT WG_PP_VARDCLNEXPLICIT_TUPLIZE(SL4)
  TEST_DIDCAPTURE_TYPE(SomeLocalType * const &, EXTRACT_PARSEDTYPE(RESULT))
