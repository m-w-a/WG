...
/*
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI1)
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI2)
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI3)
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI4)
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI5)
RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI6)
...
#define RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(x) \
  WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(x, 0)

void testNoQualBind()
{
  int var1 = 0;

#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI1)
...
#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI2)
  TEST_DIDBIND_TYPE(
...
void testRefQualBind()
{
  ...
  using namespace boost;
#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI3)
  TEST_DIDBIND_TYPE(
...
void testConstRefBind()
{
  ...
  using namespace boost;
#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI4)
  TEST_DIDBIND_TYPE(
...
struct testNoQualThisUBind
{
  ...
  {
    using namespace boost;
#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI5)
    TEST_DIDBIND_TYPE(
      BOOST_TYPEOF(this),
      EXTRACT_TYPE(RESULT) )
...
struct testConstQualThisUBind
{
  ...
  {
    using namespace boost;
#define RESULT RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_1ARG(VDI6)
    TEST_DIDBIND_TYPE(
...
#define RESCAN_WG_PP_VARDCLNIMPLICIT_TUPLIZE_2ARG(x) \
  WG_PP_VARDCLNIMPLICIT_TUPLIZE_2ARG(x, 0)
