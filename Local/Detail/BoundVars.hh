...
#define WG_PP_AUTOFUNCTION_BOUNDVARS_ISMANUALBOUND(rawbvar) \
  BOOST_PP_IIF( \
    BOOST_PP_OR( \
      ...
      BOOST_PP_OR( \
        WG_PP_TOKENS_STARTS_WITH_LOCAL(rawbvar), \
        WG_PP_TOKENS_STARTS_WITH_LOCALREF(rawbvar))), \
    1, \
    0)
...
#define WG_PP_AUTOFUNCTION_BOUNDVARS_NORMALIZEBVAR_MANUAL(rawbvar) \
  BOOST_PP_CAT( \
    ...
    BOOST_PP_EXPR_IIF(WG_PP_TOKENS_STARTS_WITH_LOCAL(rawbvar), LOCAL) \
    BOOST_PP_EXPR_IIF(WG_PP_TOKENS_STARTS_WITH_LOCALREF(rawbvar), LOCALREF) ) \
  (rawbvar)
...
#define WG_PP_AUTOFUNCTION_BOUNDVARS_NORMALIZEBVAR_AUTO(rawbvar) \
  WG_PP_BOUNDVARS_EXPAND1( \
    ...
    BOOST_PP_IIF( \
      WG_PP_TOKENS_STARTS_WITH_CONST(rawbvar), \
...
#define WG_PP_AUTOFUNCTION_BOUNDVARS_NORMALIZEBVAR_AUTO2(addconst, rawbvar) \
  WG_PP_BOUNDVARS_EXPAND2( \
    ...
    BOOST_PP_IIF( \
      WG_PP_TOKENS_STARTS_WITH_REF(rawbvar), \
