...
#define WG_PP_FORWARDER_TYPE_MEMBERTYPE_ASSIGNEE(e_or_d_type) \
  WG_PP_PARSEDTYPE_EXTRACTCPPTYPE_AND_IFNOTQUALIFIEDLOCALREF_ADDREFERENCE( \
      e_or_d_type)

#define WG_PP_FORWARDER_TYPE_MEMBERTYPE_NONASSIGNEE(e_or_d_type) \
  WG_PP_PARSEDTYPE_EXTRACTCPPTYPE_AND_IFNONLOCALTYPE_ADDCONSTADDREFERENCE( \
    e_or_d_type)
...
#define WG_PP_FORWARDER_TYPE_MEMBERDCLN_ASSIGNEE( \
  r, varrootname, indx, e_or_d_type) \
    WG_PP_FORWARDER_TYPE_MEMBERTYPE_ASSIGNEE(e_or_d_type) \
...
#define WG_PP_FORWARDER_TYPE_MEMBERDCLN(r, varrootname, indx, e_or_d_type) \
  WG_PP_FORWARDER_TYPE_MEMBERTYPE_NONASSIGNEE(e_or_d_type) \
  WG_PP_FORWARDER_TYPE_MEMBERVAR_NAME(varrootname, indx) WG_PP_IDENTITY(;)
