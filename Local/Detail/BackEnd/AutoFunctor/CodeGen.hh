...
#define WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_ASSIGNEE() \
  (ASSIGNEE)(assignee)
#define WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_BOUNDPARAM() \
  (BOUNDPARAM)(parambind)
#define WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_SETPARAM() \
  (SETPARAM)(paramset)

#define WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPECSEQ() \
  ( WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_ASSIGNEE() ) \
  ( WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_BOUNDPARAM() ) \
  ( WG_PP_AUTOFUNCTOR_CODEGEN_TYPEDDCR_SPEC_SETPARAM() )
