...
#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES2_void (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_VOID_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES2_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES3_this_ (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_THISU_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES3_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES4_local (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_LOCAL_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES4_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES5_localref (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_LOCALREF_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES5_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES6_assignto (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_ASSIGNTO_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES6_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES7_return (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_RETURN_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES7_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES8_parambind (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_PARAMBIND_IMPL(tokens) \
    BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES8_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES9_paramset (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_PARAMSET_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES9_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES10_membind (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_MEMBIND_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES10_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES11_memset (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_MEMSET_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES11_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES12_const (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_CONST_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES12_)

#define WG_PP_AUTOFUNCTOR_TOKEN_MATCHES13_ref (1) /* unary */
#define WG_PP_TOKENS_STARTWITH_REF_IMPL(tokens) \
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_IS_FRONT( \
    tokens, \
    WG_PP_AUTOFUNCTOR_TOKEN_MATCHES13_)
